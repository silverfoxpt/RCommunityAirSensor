prototype_function_to_retrieve_box_token <- function() {
  pacman::p_load(boxr)
  box_auth() # launch a webpage, as per OAuth requirements
  
  token_path <- "~/.boxr-oauth"  # or your custom path if different
  box_token <- readRDS(token_path)
